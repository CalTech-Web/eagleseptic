...
const pageSchema = {
  ...
  "@graph": [
    {
      "@type": "Service",
      name: "Drain Field Repair and Restoration",
      description: "Full drain field diagnosis, soil absorption testing, biomat treatment, targeted pipe repair, and full replacement when necessary. Permit assistance included. Serving Central Valley, California.",
      provider: { "@type": "LocalBusiness", name: "Eagle Septic Guide", url: "https://eaglesepticpumping.com" },
      areaServed,
      priceRange: "$3000-$15000",
      url: "https://eaglesepticpumping.com/services/drain-field-repair",
    },
    {
      "@type": "BreadcrumbList",
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Drain Field Repair and Restoration" },
      ],
    },
  ],
};
